...
import wake from "../Sentience/wake.mjs";
...
class Entity {
	...
	constructor(obj,name,desc ) {
		...
		if( !entity.theVoid ) theVoid = entity.theVoid = this;
		...
		import( file ) {
			if( this.thread ) {
				return this.thread.runFile( file );
			} else 
				throw new Error( this.name+ ": Please wake() this object first.");
		}
		require (file) { 
