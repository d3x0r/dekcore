...
// create is apparently in the context, so I'm an entity?



import {Protocol} from "sack.vfs/Protocol";

class WebConsole extends Protocol {
	constructor() {
		super( { uiPath: "../../ui", npmPath:"../../.." } );
		this.on( "accept", async (ws)=>{
...
// start listening on this object.
...
if( await import( "sack.vfs/isTopLevel" ) ) {
