...
const coreThreadEventer = {
	postMessage(msg) {
		console.log( "Send to worker parent - but this should be outside myself..." );
	}	,
	on( name, cb ) {
...
function doLog(...args) {
	...
	sack.log( util.format( new Error().stack ) );
